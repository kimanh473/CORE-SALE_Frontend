...
export const useAttributeGroup = defineStore('AttributeGroup', {
  ...
  getters: {
    ...
    getListSetAttribute: (state: any) => {
      return (payload: any) => {
        ...
        state.listDefault = payload[0].json_group_attribute_detail.map(
          (item: any) => ({
            title: item.title,
            attribute: item.attribute_detail,
          })
        )
        state.listSpecDefault = payload[0].json_group_specification_detail.map(
          (item: any) => ({
            title: item.title,
            attribute: item.attribute_detail,
          })
    ...
    getListAttribute: (state: any) => {
      return (payload: any) => {
        ...
        state.listAttributeGroupOption = payload.map(
          (item: DataGroupAttribute) => ({
            id: item.id,
  ...
  actions: {
    ...
    async createAttributeGroupAction(
      data: object,
      toast: any,
      router: any,
    ...
    async createAttributeCategoryAction(
      data: object,
      toast: any,
      router: any,
      EndTimeLoading: Function
