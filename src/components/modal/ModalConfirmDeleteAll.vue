      ...
      >
        <div class="modal__container absolute" @mousedown="dragMouseDown">
          <div class="modal__header">
            <div class="modal__close" @click="handleCloseDetailAll">
              <i class="fal fa-times text-white"></i>
            </div>
          </div>
          <div class="modal__body">
            <div>
              <h1 class="header-modal">Xác nhận xóa tất cả</h1>
              ...
              <div class="bg-button-modal">
                <button class="button-modal" @click="ConfirmDeleteAll">
                  Xác nhận
                </button>
                <button
                  class="button-close-modal"
                  @click="handleCloseDetailAll"
                >
                  Hủy bỏ
                </button>
              </div>
