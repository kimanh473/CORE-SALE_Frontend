    ...
    <template v-slot:header>
      <Header :is-show-search="false">
        <template v-slot:name
          ><p class="pl-5 text-[16px]">Cập nhật nhân sự</p></template
        >
      </Header>
    </template>
                    ...
                    <div>
                      ...
                      <div>
                        <input
                          ...
                          v-model="detailUser.email_personal"
                        />
                        <p
                    ...
                    <div>
                      ...
                      <div>
                        <input
                          ...
                          class="form-control-input"
                          placeholder="Nhập email"
                          v-model="detailUser.email_company"
                        />
                        <p
                          v-if="messageError?.contact_email"
                          class="text-red-600"
                  ...
                  <div class="form-small">
                    ...
                    <div class="grid grid-cols-2 gap-2 form-small">
                      <div>
                        ...
                        <a-select
                          class="form-control-input"
                          v-model:value="detailUser.group_id"
