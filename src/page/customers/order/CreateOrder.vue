  ...
  <base-layout>
    ...
    <template v-slot:header>
      <Header :is-show-search="false">
        ...
        ><p class="pl-5 text-[16px]">Tạo mới đơn hàng</p></template
        >
      </Header>
    </template>
                            ...
                            <div class="grid grid-cols-2 gap-2 form-small">
                              <div>
                                ...
                                >Mã <span class="text-red-600">* </span>
                                  <span>{{last_code.substring(3,).padStart(8,'0')}}</span
                                  ></label>
                                <div>
                                  <input
                                      type="text"
                              ...
                              <div>
                                ...
                                <div>
                                  <a-select
                                      ...
                                      :fieldNames="{ label: 'web_name', value: 'id' }"
                                      mode="multiple"
                                  >
                                  </a-select>
                                  <!--                                  <p
                              ...
                              <div class="flex-1 mr-5">
                                ...
                                <div>
                                  <a-select
                                      ...
                                      placeholder="Chọn thành phố"
                                      :options="listAllCity"
                                      v-model:value="payDataOption[index].address_state_id"
                                      @change="handleChangeCityPay(Number(payDataOption[index].address_state_id),listAllCity,index)"
                                      :fieldNames="{ label: 'title', value: 'ID' }"
                                  >
                                  </a-select>
                                  <!--                                  <p
                              ...
                              <div class="flex-1 mr-5">
                                ...
                                <div>
                                  <a-select
                                      ...
                                      placeholder="Chọn thành phố"
                                      :options="listAllDistrict"
                                      v-model:value="payDataOption[index].address_district_id"
                                      @change="handleChangeDistrictPay(Number(payDataOption[index].address_district_id),listAllDistrict,index)"
                                      :fieldNames="{ label: 'title', value: 'ID' }"
                                  >
                                  </a-select>
                                  <!--                                  <p
                              ...
                              <div class="flex-1">
                                ...
                                <div>
                                  ...
                                  <a-select
                                      ...
                                      placeholder="Chọn xã, phường, thị trấn"
                                      :options="listAllWard"
                                      v-model:value="payDataOption[index].address_ward_id"
                                      @change="handleChangeWardPay(Number(payDataOption[index].address_ward_id),listAllWard,index)"
                                      :fieldNames="{ label: 'title', value: 'ID' }"
                                  >
                                  </a-select>
