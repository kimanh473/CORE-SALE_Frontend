...
<script setup lang="ts">
  ...
  console.log(listAttributeProductOption.value)
  ...
  const createAttribute = () => {
    attribute.json_attribute = rightRowData.value.map((item: any) => item.code)
    groupAttribute.createAttributeGroupAction(
      attribute,
      toast,
      router,
      EndTimeLoading
